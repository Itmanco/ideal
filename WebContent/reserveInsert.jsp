...
<title>Insert Reserve</title>
<script type="text/javascript" src="<%= request.getContextPath() %>/js/utils.js"></script>
<script>  
    window.onload = function() {
        const reservedYearInput = document.getElementById("reservedYear");
        if (reservedYearInput) {
            // If there's a reserved year, the page is being loaded for an existing reservation.
            // We need to trigger the month and day population based on the reserved year.
